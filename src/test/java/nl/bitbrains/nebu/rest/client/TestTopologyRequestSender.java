...
public class TestTopologyRequestSender extends JerseyTest {
    ...
    @Path(RequestBuilder.URI_TOPOLOGY)
    public static class TopologyResource {
        ...
        @GET
        public Response getTopology() throws JDOMException {
            Response rep = null;
    ...
    public void testBasicGetTopologyRequest() throws CacheException {
        ...
        final PhysicalTopology topology = RequestSender.get().getTopology();
